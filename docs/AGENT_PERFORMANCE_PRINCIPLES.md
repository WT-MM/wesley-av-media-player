...
- **Workspaces over per-item allocation**: no allocation in loops that run
  ...
  Third-party decoder/demuxer allocation and synchronization are permitted only on
  bounded decode/source workers, with measured costs and explicit resource admission.
