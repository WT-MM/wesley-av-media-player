...
enum class NativeSourceClass { Network, BufferedLocal, FastLocal };
...
struct NativeOpenPreflightResult final {
  ...
  NativeSourceClass sourceClass{NativeSourceClass::Network};
...
public:
  ...
  struct Dependencies final {
    ...
    std::function<NativeSourceClass(const std::string &, const std::string &)>
        classifySource;
