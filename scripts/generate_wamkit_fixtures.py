...
import argparse,hashlib,json,os,pathlib,subprocess,shutil,tempfile
...
output=a.output; scratch=pathlib.Path(os.environ.get("TMPDIR", "/private/tmp/wam-wamkit-scratch"));scratch.mkdir(exist_ok=True)
