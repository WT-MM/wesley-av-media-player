...
framework=pathlib.Path(sys.argv[1]);scratch=pathlib.Path(os.environ.get('WAM_TEST_SCRATCH','/private/tmp/wam-wamkit-scratch'));scratch.mkdir(exist_ok=True)
